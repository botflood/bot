...
// function change(){
        ...
        $code1 = request('/go-promotions/v1/promotions/enrollments', $token, '{"promo_code":"G-L88GH4F"}');
        ...
        $code1 = request('/go-promotions/v1/promotions/enrollments', $token, '{"promo_code":"G-Y2NH3DN"}');
        $message = fetch_value($code1,'"message":"','"');
        if(strpos($code1, 'Promo kamu sudah bisa dipakai.')){
        echo "\n".color("green","".$message);
        goto gofood;
        ...
        $code1 = request('/go-promotions/v1/promotions/enrollments', $token, '{"promo_code":"G-G-8ZDSPQH"}');
        $message = fetch_value($code1,'"message":"','"');
        echo "\n".color("green","".$message);
        echo "\n".color("nevy","▶️ Klaim ");
        echo color("yellow","▶️ boot...");
        ...
        sleep(5);
        $boba09 = request('/go-promotions/v1/promotions/enrollments', $token, '{"promo_code":"G-8ZDSPQH"}');
